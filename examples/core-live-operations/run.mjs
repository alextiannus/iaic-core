...
import {readAgentTaskSources} from '@immedi/iaic-core/operations/task-source.js';
async function run(){
...
await run();
console.log(JSON.stringify({durableRegistration:true,executorGenerationFencing:true,privateFreeTaskProjection:true,providerCalled:false}));
