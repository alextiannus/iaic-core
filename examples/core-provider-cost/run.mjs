...
try{
 ...
 const rates=new PostgresModelRateLimits({pool,namespace:'fixture-provider-account',requestsPerMinute:10,tokensPerMinute:1000});await rates.initialize();
 ...
 console.log(JSON.stringify({example:'core-provider-cost',status:'passed',providerTokens:'150',platformUnits:'330',estimatedMinorUnitsNumerator:'84600000000',costObserved:true,sharedModelCapacity:true,sharedAdmissionRate:true,actualCurrencyCharge:false}));
