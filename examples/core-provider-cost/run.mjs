...
import {TokenLedger,ProviderCostAccounting,meteredModel,TaskStore,AgentRuntime,ContextAssembler,CapabilityDispatcher,defineCapability,createTaskObservationSource} from '@immedi/iaic-core';
...
try{
 ...
 const model=meteredModel({model:{name:'fixture',next:async()=>({type:'finish',result:{done:true},usage:{inputTokens:100,cachedInputTokens:20,outputTokens:50,reasoningOutputTokens:10}})},ledger,scope,policy:{maximum:'500',price:{revision:'allowance-v1',input:'2',cachedInput:'1',output:'3'},costBasis}});
