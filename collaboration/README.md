...
Remaining: persistent cross-principal Agent Task binding, shared platform-unit expense reservations/settlement, artifact sharing, propagated task cancellation and failure takeover. The existing TaskHandoffs remains same-owner until these bindings are implemented. A payer label and a capability-call ceiling do not satisfy Note 30's full collaboration budget acceptance.
