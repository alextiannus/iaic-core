...
for(const name of ['app.mjs','config.mjs','server.mjs','job.json','vendor/core.tgz',...job.configuration.skills.map(p=>'skills/'+p)]){sourceHash.update(name);sourceHash.update(await fs.readFile(new URL(name,import.meta.url)));}
