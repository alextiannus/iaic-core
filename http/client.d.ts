...
export class CapabilityHttpError extends Error {
  constructor(message?: string, details?: {code?: string; statusCode?: number; outcomeUnknown?: boolean; requestKey?: string; recovery?: string; validation?: unknown; cause?: unknown});
  code?: string; statusCode?: number; outcomeUnknown?: boolean; requestKey?: string; recovery?: string; validation?: unknown;
}
