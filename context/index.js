...
export class ContextAssembler {
  constructor({skillRoot,maxBytes=120000,memoryProvider=null,skillCatalog=null,sessionProvider=null,handoffProvider=null,overflow='error'}) {if(!['error','omit-old-results'].includes(overflow))throw new Error('Invalid context overflow mode');this.overflow=overflow;this.skillRoot=skillRoot;this.maxBytes=maxBytes;this.memoryProvider=memoryProvider;this.skillCatalog=skillCatalog;this.sessionProvider=sessionProvider;this.handoffProvider=handoffProvider;}
  async assemble({task,capability,history,actor,dispatcher}) {
    ...
    const content=boundedHistory(data,this.maxBytes,this.overflow);
