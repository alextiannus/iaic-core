...
| `v0.1.0-candidate.106` | Access diagnostics prepared; current upon verified publication | On replacement, record an explicit date 14 days later | See capabilities/ACCESS_DIAGNOSTICS.md; no database migration |
