...
| `v0.1.0-candidate.105` | Model readiness gate prepared; current upon verified publication | On replacement, record an explicit date 14 days later | See agent/MODEL_READINESS.md; no database migration |
